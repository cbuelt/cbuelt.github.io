...
Before the start of my PhD I obtained a Bachelor's degree in Industrial Engineering and a Master's degree in Mathematics from Karlsruhe Institute of Technology.

My research revolves around uncertainty quantification, probabilistic modeling, and their applications in the natural sciences. I have a strong interest in the theoretical foundations of such methods, as well as in their practical applications. Furthermore, I am interested in developing novel probabilistic or uncertainty quantification-related methods for neural networks. Applications of the developed methods include [meteorology](https://journals.ametsoc.org/view/journals/aies/aop/AIES-D-24-0049.1/AIES-D-24-0049.1.xml), [dynamical systems](https://openreview.net/forum?id=gangoPXSRw) or [energy systems](https://www.sciencedirect.com/science/article/pii/S2666546823000113).

**Current research interests:**
- Probabilistic predictions
  - Probabilistic methods on function spaces
  - Forecasting of dynamical systems
  - Proper scoring rules
- Uncertainty quantification
  - Uncertainty in regression tasks
  - Analysis of uncertainty measures
- Physics-informed machine learning
  - Neural operators and probabilistic predictions
  - Applications in meteorology and imaging 
